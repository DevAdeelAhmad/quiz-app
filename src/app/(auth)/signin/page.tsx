...
const SignInPage = () => {
  ...
  return (
    <main className="flex items-center justify-between min-h-screen w-full text-center">
      <Link
        href="/"
        className="hidden lg:flex flex-col gap-2 items-center justify-center absolute top-10 right-10"
      >
        <Image
      ...
      <div className="flex-1 flex flex-col items-center justify-center min-h-screen gap-10 px-2">
        ...
        <div
          className="flex items-center justify-between gap-5 px-4 py-2 rounded-full border-gray-700 border cursor-pointer hover:shadow-md"
          onClick={handleSignInWithGoogle}
        >
          <Image
            src="/assets/auth/google-icon.png"
            alt="Google Icon"
            width={30}
            height={30}
          />
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSignInWithEmail}>
          <Input
            className="border-gray-800 w-[300px] rounded-full"
            type="email"
            required
