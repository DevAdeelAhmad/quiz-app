        ...
        <section className='flex flex-col gap-5 p-5 lg:p-10 items-center justify-center w-full'>
            <div className='flex flex-col md:flex-row gap-3 md:w-full'>
                <div className='flex-1'>
                    <h1 className='text-2xl lg:text-3xl md:pl-44 font-semibold text-center'>Quiz Categories</h1>
                </div>
                <Link className='flex justify-center align-middle' href='/category'>
                    <Button className='bg-[#ee0022] text-white font-semibold rounded-3xl hover:bg-[#ee0022]/60'>All Categories <GrFormNextLink className="mr-2 h-4 w-4" /></Button>
                </Link>
            </div>
                        ...
                        >
                            {CategoryData.map((category, index) => (
                                <SwiperSlide style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} key={index}>
                                    <Link
                                        className='flex flex-col gap-3 items-center justify-center w-[150px] min-[450px]:!w-[200px] px-10 py-5 rounded-2xl border hover:bg-third hover:text-white transition-all duration-300 shadow-lg'
                                        key={index}
