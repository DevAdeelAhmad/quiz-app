...
const QuizCreationForm: React.FC<QuizCreationFormProps> = ({
  ...
  const [duration, setDuration] = useState(
    initialQuestionData?.duration || null
  );
  const [tags, setTags] = useState<string[]>(initialQuestionData?.tags || []);
        ...
        <div>
          <Label className="text-lg font-normal" htmlFor="tags">
            ...
            <span className="text-sm md:text-sm">
              (Press Space to add multiple tags)
            </span>
          </Label>
          <Input
            type="text"
      ...
      {isAccessEmailsVisible && (
        <div>
          <Label className="text-lg font-normal" htmlFor="accessEmails">
            Access Emails{" "}
            <span className="text-sm md:text-sm">
              (Press Space to add multiple emails)
            </span>
          </Label>
          <Input
            type="text"
